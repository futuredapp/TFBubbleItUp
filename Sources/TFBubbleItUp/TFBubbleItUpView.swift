...
@IBDesignable public class TFBubbleItUpView: UICollectionView, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource, UIGestureRecognizerDelegate, TFBubbleItUpViewCellDelegate {
    ...
    public func replaceItemsTextAtPosition(position: Int, withText text: String, resign: Bool = true, completion: (() -> Void)? = nil) throws {
    ...
    public func replaceLastInvalidOrInsertItemText(text: String, switchToNext: Bool = true, completion: (() -> Void)? = nil) {
    ...
    private func invalidateIntrinsicContentSize(completionBlock: (() -> Void)?) {
    ...
    func needUpdateLayout(cell: TFBubbleItUpViewCell, completion: (() -> Void)?) {
    ...
    func removeItem(at index: Int, completion: (() -> Void)?) throws {
